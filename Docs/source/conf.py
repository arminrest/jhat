...
sys.path.insert(0, os.path.abspath('../../jhat'))


# -- Project information -----------------------------------------------------

project = 'jhat'
copyright = '2022 Armin Rest & Justin Pierel'
...
sphinx_gallery_conf = {
    ...
    'doc_module': ('jhat',),  # documented module(s)
...
latex_documents = [
    (master_doc, 'jhat'+'.tex', 'jhat'+' Documentation',
     'Armin Rest & Justin Pierel', 'manual'),
]
...
man_pages = [
    (master_doc, 'jhat', 'jhat'+' Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jhat', 'jhat'+' Documentation',
     author, 'jhat', 'One line description of project.',
     'Miscellaneous'),
]
